...
if(op==1):
 os.system("clear")
 os.system("cd && cd Omindu-Hacker-ToolX && cd pyshell && ./Pyshell && cd && cd AllHackingTools && python2 MainMenu.py")
elif(op==2):
 os.system("clear")
 os.system("cd && cd Omindu-Hacker-ToolX && cd wishfish && ./wishfish.sh && cd && cd AllHackingTools && python2 MainMenu.py")
elif(op==3):
 os.system("clear")
 os.system("cd && cd Omindu-Hacker-ToolX && cd lockphish && bash lockphish.sh && cd && cd AllHackingTools && python2 MainMenu.py")
elif(op==4):
 os.system("clear")
 os.system("cd && cd Omindu-Hacker-ToolX && cd Files && bash HatCloud.sh && cd && cd AllHackingTools && python2 MainMenu.py")
elif(op==5):
 time.sleep(0.2)
