...
if(op==1):
 ...
 os.system("cd && cd Omindu-Hacker-ToolX && cd src && bash SpeedUpdate.sh")
elif(op==3):
 time.sleep(0.2)
 print("\033[1;31;40mQuiting Omindu-Hacker-ToolX Updater...")
 sys.exit()
else:
 print("\033[1;31;40mInvalid input. Quiting Omindu-Hacker-ToolX Updater") 
 time.sleep(0.8)
